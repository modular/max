...
struct StringSlice[mut: Bool, //, origin: Origin[mut]](
    ...
    fn __init__(
        ...
        *,
        ...
        self = Self(unsafe_from_utf8=rebind[Span[Byte, origin]](byte_slice))
    ...
    fn __init__(
        ...
        *,
        ...
        """
        self = Self(
            unsafe_from_utf8=rebind[Span[Byte, origin]](
                Span(ptr=ptr, length=length)
            )
        )
    ...
    fn __eq__(self, rhs: StringSlice) -> Bool:
        ...
        elif s_len == 0 or Int(s_ptr) == Int(rhs_ptr):
            return True
...
fn _memchr_simple[
    ...
    for i in range(len):
        if source[i] == char:
            return __type_of(source)(source + i)
    return __type_of(source)()
...
fn _memrchr[
    ...
    for i in reversed(range(len)):
        if source[i] == char:
            return rebind[__type_of(source)](source + i)
    return __type_of(source)()
